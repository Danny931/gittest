...
export const NETWORKS = {
  ...
  bsc: {
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "BUSD", "DODO", "DOMI", "MCB", "oneDODO", "OLO", "PSP"],
    lqMintTokenSymbolBlackList: ["DOMI", "oneDODO", "OLO", "PSP"],
  },
  ...
  arbitrum: {
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "DODO", "MCB", "IMX", "XTK"],
    lqMintTokenSymbolBlackList: [],
  },
  Avalanche: {
    name: "Avalanche",
...
export const getNetworkById: (chainId: number) => NetworkInfo = (chainId: number) => {
  ...
  for (const network of Object.values(NETWORKS)) {
    if (network.chainId === chainId || network.chainId === Number(chainId)) {
      return network;
    }
  }
