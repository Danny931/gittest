  ...
  return (
    <div className={classes.flexCenter}>
      ...
      {web3Modal.cachedProvider ? (
        <Menu className={classNames(classes.menulogin, classes.menu)} selectedKeys={[route]} mode="horizontal">
        ...
        <Menu className={classNames(classes.menuLogout, classes.menu)} selectedKeys={[route]} mode="horizontal">
          <Menu.Item key="transfer">
            <Link to="/transfer">Transfer</Link>
          </Menu.Item>
          <Menu.Item key="liquidity">
