...
import { Chain, Token } from "../../constants/type";
...
const TransDetail: FC<IProps> = ({ amount, receiveAmount }) => {
  ...
  if (estimateAmtInfoInState) {
    ...
    minimumReceived =
      ...
      " " +
      getTokenDisplaySymbol(selectedToken?.token, toChain);
  }
    ...
    <div className={classes.historyDetail}>
      <div className={classes.detailItem}>
        ...
        <div className={classes.itemRight}>
          ...
          <div className={classes.fromNet}>{getTokenSymbol(selectedToken?.token.symbol, fromChain?.id)}</div>
        </div>
      </div>
      <div className={classes.detailItem}>
        <div className={classes.itemLeft}>
